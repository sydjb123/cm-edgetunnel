...
let subPath = 'ck';     // 节点订阅路径,不修改将使用UUID作为订阅路径
let proxyIP = 'proxyip.hk.cmliussss.net';  // proxyIP 格式：ip、域名、ip:port、域名:port等,没填写port，默认使用443,也可以是socks5
let password = '510f5d3c-8ca0-4cff-8a44-b1a8226886ce';  // 节点UUID
let SSpath = 'u';          // 路径验证，为空则使用UUID作为验证路径

// CF-CDN 
let cfip = [ // 格式:优选域名:端口#备注名称、优选IP:端口#备注名称、[ipv6优选]:端口#备注名称、优选域名#备注 
    '104.16.39.36#HK', '104.16.35.191#HK', '104.16.37.84#HK','cf.130519.xyz#KR','104.18.29.2#HK', 
    '104.16.40.36#HK', '104.16.44.99#HK','104.16.32.183#HK','sub.danfeng.eu.org#TW','cf.zhetengsha.eu.org#HK'
];  // 感谢各位大佬维护的优选域名
